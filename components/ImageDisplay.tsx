            ...
            <div className={`grid gap-4 ${images.length > 1 ? 'grid-cols-2' : 'grid-cols-1'}`}>
                ...
                >
                    ...
                    <div className="absolute top-2 right-2 flex flex-col space-y-2 pointer-events-auto opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <button onClick={(e) => { e.stopPropagation(); onEditImage(image); }} title="Editar" className="p-2 bg-gray-900/60 text-white hover:bg-indigo-600 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" /><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd" /></svg>
                        </button>
                        <button onClick={(e) => { e.stopPropagation(); onEditWithMask(image); }} title="Máscara" className="p-2 bg-gray-900/60 text-white hover:bg-indigo-600 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a1 1 0 00-1 1v1a1 1 0 002 0V3a1 1 0 00-1-1zM4 9a1 1 0 01-1-1V4a1 1 0 012 0v4a1 1 0 01-1 1zm13-5a1 1 0 00-1 1v4a1 1 0 102 0V5a1 1 0 00-1-1zM9 16a1 1 0 01-1 1H4a1 1 0 110-2h4a1 1 0 011 1zm7-1a1 1 0 00-1-1h-4a1 1 0 100 2h4a1 1 0 001-1zM10 8a2 2 0 100-4 2 2 0 000 4z" /><path fillRule="evenodd" d="M.46 12.043c.29.29.77.29 1.06 0l4.354-4.353a.5.5 0 01.708 0l2.12 2.121a.5.5 0 00.708 0l2.121-2.12a.5.5 0 01.708 0l4.353 4.353c.29.29.29.77 0 1.06l-4.353 4.354a.5.5 0 01-.708 0L9.31 15.54a.5.5 0 00-.708 0l-2.12 2.121a.5.5 0 01-.708 0l-4.354-4.353-.001-.002z" clipRule="evenodd" /></svg>
                        </button>
                        <button onClick={(e) => { e.stopPropagation(); setImageToResize(image); }} title="Redimensionar" className="p-2 bg-gray-900/60 text-white hover:bg-indigo-600 rounded-full">
                    ...
                    <div className="absolute bottom-2 right-2 flex items-center space-x-1 bg-gray-900/60 p-1 rounded-lg pointer-events-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <button onClick={(e) => { e.stopPropagation(); handleZoom(index, 1.2); }} className="p-1.5 text-white hover:bg-gray-700 rounded-md"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" /></svg></button>
                        <button onClick={(e) => { e.stopPropagation(); handleZoom(index, 1 / 1.2); }} className="p-1.5 text-white hover:bg-gray-700 rounded-md disabled:text-gray-500" disabled={!isZoomed}><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM13 10H7" /></svg></button>
                        <button onClick={(e) => { e.stopPropagation(); handleReset(index); }} className="p-1.5 text-white hover:bg-gray-700 rounded-md disabled:text-gray-500" disabled={!isZoomed}><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5M20 20v-5h-5M4 20h5v-5M20 4h-5v5" /></svg></button>
                    </div>
                </div>
                );
                })}
