...
export const Dashboard: React.FC<DashboardProps> = ({ setActiveView }) => {
    const tools = [
        // 1. GERADOR PRINCIPAL (Sempre em primeiro)
        {
            id: 'generator',
        ...
        // 2. ORDEM ALFABÉTICA (Estúdio de...)
        {
            id: 'anatomy',
            title: "Estúdio de Anatomia", // Antes: Estúdio Biodigital
            description: "Explore o corpo humano. Gera ilustrações anatómicas e relatórios médicos detalhados.",
            color: "bg-cyan-500",
        ...
        },
        {
            ...
            description: "Transforme fotos estáticas em vídeos. Zoom, Shake e Movimento a Custo Zero.",
        ...
        {
            id: 'chef',
            title: "Estúdio de Culinária", // Antes: Chef AI Michelin
            description: "O seu Chef Michelin pessoal. A IA cria receitas gourmet baseadas nos seus ingredientes.",
            color: "bg-orange-500",
        ...
        {
            id: 'decipher',
            title: "Estúdio de Decifração", // Antes: Decifrador de Manuscritos
            description: "Traduza e transcreva textos antigos a partir de fotos. O Indiana Jones digital.",
            color: "bg-amber-600",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
        },
        {
            id: 'interiorDesign',
            title: "Estúdio de Design de Interiores", // Antes: Design de Interiores
        ...
        {
            id: 'weather',
            title: "Estúdio de Meteorologia", // Antes: O Tempo à Antiga
        ...
        {
            id: 'poetry',
            title: "Estúdio de Poesia & Música", // Antes: Poesia & Música
            description: "Escreva, ouça e sinta. Gere poemas e letras de música e dê-lhes voz com IA.",
            color: "bg-rose-500",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" /></svg>,
        },
        {
            id: 'backgroundRemover',
            title: "Estúdio de Remoção de Fundo", // Antes: Removedor de Fundo
        ...
        {
            id: 'threeD',
            title: "Estúdio de Renderização 3D", // Antes: Estúdio Render 3D
            description: "Transforme fotos em renders 3D impressionantes: Cartoon, Claymation, Voxel e mais.",
            color: "bg-violet-500",
        ...
        {
            id: 'restoration',
            title: "Estúdio de Restauro", // Antes: Restauro de Fotos
        ...
        {
            id: 'portrait',
            title: "Estúdio de Retratos", // Antes: Retratos AI
        ...
        {
            id: 'upscaler',
            title: "Estúdio de Super Resolução", // Antes: Super Resolução
        ...
        {
            id: 'textEditor',
            title: "Estúdio de Texto", // Antes: Editor de Texto
        ...
        {
            id: 'translator',
            title: "Estúdio de Tradução", // Antes: Tradutor Universal
        ...
        {
            id: 'transcription',
            title: "Estúdio de Transcrição", // Antes: Transcrição de Áudio
        ...
        },
        {
            ...
            description: "Ajuste a opacidade das suas imagens e crie sobreposições fantasmagóricas.",
            color: "bg-gray-400",
        ...
        },
        {
            ...
            description: "Crie logótipos SVG reais ou ilustrações com estilo vetorial perfeitas para design.",
            color: "bg-indigo-400",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" /></svg>,
        },
        {
            id: 'video',
            title: "Estúdio de Vídeo", // Antes: Estúdio de Vídeo AI
            description: "Geração real de vídeo com o modelo Veo (Requer chave API paga).",
            color: "bg-purple-800",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>,
            badge: "Pago"
        },
        // 3. 'Estúdio do...' vem depois de 'Estúdio de...' na ordenação (e depois de 'o' na tabela ASCII)
        {
            id: 'euromillions',
            title: "Estúdio do Euromilhões", // Antes: Euromilhões
